...
class MascotasCrear extends React.Component {
    ...
    async add() {
        ...
        const response = await APIInvoke.invokePOST("/api/v1/mascota", data)
                ...
                <div className="container mt-5 ">
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            <h2 className="text-center text-white">REGISTRO DE MASCOTAS</h2>
                            ...
                            <div className="form-group">
                                <label for="tipo" className="form-label text-white">Tipo: </label>
                            ...
                            <div className="d-grid gap-2 ">
                                <button onClick={this.add.bind(this)} type="submit" tabindex="6" className="btn btn-dark btn-lg">Registrar</button>
